  ...
  template: `
    <div class="space-y-6">
      <div class="flex flex-wrap items-center justify-between gap-4">
        <div>
          <div class="text-2xl font-semibold">Subscriptions</div>
          <div class="text-sm text-slate-500">Manage recurring service charges</div>
        </div>
        <button
      ...
      <div class="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
        <div class="text-sm font-semibold text-slate-800">Upcoming charges</div>
        <table class="mt-3 w-full text-sm">
          ...
          <tbody>
            ...
            <tr *ngIf="occurrences.length === 0">
              <td colspan="6" class="py-4 text-center text-sm text-slate-500">No upcoming charges</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div class="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
        <div class="text-sm font-semibold text-slate-800">Subscriptions</div>
        <table class="mt-3 w-full text-sm">
          <thead class="text-left text-xs uppercase tracking-wide text-slate-400">
            <tr>
          ...
          <tbody>
            <tr *ngFor="let item of subscriptions" class="border-t border-slate-100">
            ...
            <tr *ngIf="subscriptions.length === 0">
              <td colspan="6" class="py-4 text-center text-sm text-slate-500">No subscriptions</td>
            </tr>
          </tbody>
        </table>
      </div>
